...
.annotorious-hint-icon {
  ...
  top:6px;
  left:5px;
  background:url(../images/theme-dark/feather_icon.png);
...
.top-left:after, .annotorious-editor:after {
  content:url(../images/theme-dark/Indicator.png);
  position:absolute;
  left:15px;
  top:-14px;
  height:18px;
...
.annotorious-popup-button-delete:hover {
  background-color:transparent;
  background:url(../images/theme-dark/DarkSprite.png) no-repeat;
...
.annotorious-editor-button-container {
  background:url(../images/theme-dark/DarkSprite.png);
